      ...
      column(
        ...
        tags$p(
              tags$a("campotel-nordostsee.de",
               href = "https://www.campotel-nordostsee.de/buchen",
        ...
        tags$br(style = "line-height: 20px"),
        tags$p("Gibt uns bitte im Formular Bescheid, falls ihr im Campotel übernachtet UND mit uns frühstücken wollt:", style = "font-family: \'MrsEavesItalic\'; font-weight: bold; color: #4b0082; font-size: 20px; letter-spacing:3px; text-align: center"),
