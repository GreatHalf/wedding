  ...
  tagList(
    ...
    tags$div(class = "landing-block foreground-content",
             tags$div(class = "foreground-text",
                      ...
                      tags$p("Gosch's Gasthof Schleswig", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                      tags$p("Friedrichstraße 86, 24837 Schleswig", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                      tags$p("Engster Kreis | Eingeladen sind nur die Eltern, Trauzeugen, Brüder und deren Partnerinnen", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                      tags$br(style = "line-height: 80px"),
